 ...
 */
export declare function getTodoConfig(baseDir: string, todoConfig?: TodoConfig): TodoConfig | undefined;
/**
 ...
 * @param baseDir - The base directory that contains the project's package.json.
 */
export declare function ensureTodoConfig(baseDir: string): void;
/**
 ...
 */
export declare function writeTodoConfig(baseDir: string, todoConfig: TodoConfig): boolean;
